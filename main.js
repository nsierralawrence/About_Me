...
var arcadeCounter = 6;
var game = ['Marvel vs Capcom', 'Initial D', 'Metal Slug', 'Tekken', 'Mortal Kombat 2']
var rightGame = false;


do{
    var arcadeAnswer = prompt('Which arcade game landed Ramses a job?')
    
for(var i = 0; i < game,length; i++){
    if(states[i] === arcadeAnswer){
        rightGame = true;
    }
}
